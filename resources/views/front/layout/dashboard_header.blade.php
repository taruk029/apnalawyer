        ...
        <div class="clever-main-menu">
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="cleverNav">
                    ...
                    <a class="nav-brand" href="{{ url('dashboard')}}"><img src="{{ asset('public/front/img/core-img/logo.png') }}" alt=""></a>
                    @else
                     <a class="nav-brand" href="javascript:void(0)"><img src="{{ asset('public/front/img/core-img/logo.png') }}" alt=""></a>
                    @endif
                    @if(Request::segment(1)!="user_test" || Request::segment(1)!="pause_section" || Request::segment(1)!="end_section" )
